...
import { Input, Modal, Form, ColorPicker, Collapse, Button, Space, App, Switch, Typography, Radio } from 'antd'
import { PlusOutlined, DeleteOutlined, EditOutlined, LockOutlined } from '@ant-design/icons'
import type { CXEndpoint, CXProviderKey, CXLaunchItem, McpServer } from '@shared/types'
