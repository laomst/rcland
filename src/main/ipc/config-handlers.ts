...
export function registerConfigHandlers(): void {
  ...
  // ---- MCP Servers ----
  ipcMain.handle('mcp-servers:load', () => configService.loadMcpServersData())
  ipcMain.handle('mcp-servers:save', (_e, data: McpServersData) => configService.saveMcpServersData(data))
